...
CREATE TABLE `direccion` (
  ...
  KEY `fk_direccion_municipio_idx` (`idmunicipio`),
  CONSTRAINT `fk_direccion_municipio` FOREIGN KEY (`idmunicipio`) REFERENCES `municipio` (`idmunicipio`) ON DELETE NO ACTION ON UPDATE NO ACTION
