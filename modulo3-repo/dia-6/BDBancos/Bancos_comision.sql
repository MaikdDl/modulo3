...
CREATE TABLE `comision` (
  ...
  `valor_comision` decimal(18,2) NOT NULL DEFAULT '0.00',
  `idtipo_cuenta` int(11) NOT NULL,
  PRIMARY KEY (`idcomisiones`),
  KEY `fk_comision_tipo_cuenta_idx` (`idtipo_cuenta`),
  CONSTRAINT `fk_comision_tipo_cuenta` FOREIGN KEY (`idtipo_cuenta`) REFERENCES `tipo_cuenta` (`idtipo_cuenta`) ON DELETE NO ACTION ON UPDATE NO ACTION
